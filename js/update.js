var serverUrl = "/appapi/getLastedVersion";
...
function getUpdateData(phoneType,auto) {
	...
	COM.post("/appapi/getLastedVersion",{
		data:{
...
function checkUpdateData( data, auto){
	...
	plus.runtime.getProperty(plus.runtime.appid,function(info){
        curVer=info.version;
        COM.console("当前版本 : "+curVer+"    服务器版本："+data.version);
		if ( data ){
